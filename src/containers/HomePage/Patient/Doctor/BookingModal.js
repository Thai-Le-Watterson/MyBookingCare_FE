...
class BookingModal extends React.Component {
  ...
  handleChangeDatePicker = (arg) => {
    ...
    const date =
      new Date(arg[0]).getDate() +
      "/" +
      (new Date(arg[0]).getMonth() + 1) +
      "/" +
      new Date(arg[0]).getFullYear();
    console.log(date);
    this.setState({
      dateBirth: date,
    });
  ...
  handleBookingSchedule = async () => {
    ...
    const dataRequest = {
      ...
      timeData:
        schedule.timeData[language === languages.VI ? "valueVi" : "valueEn"],
      reason,
      language,
    };
  ...
  render() {
    ...
    const position =
      ...
      doctor.positionData[language === languages.VI ? "valueVi" : "valueEn"];
    const time =
    ...
    const avatar =
      (doctor.image && Buffer.from(doctor.image).toString()) || avatarDefault;
    const price =
              ...
              <div className="row">
                <div className="col-6 my-2 book-type_container">
                  <div className="form-check">
                    <input
                      ...
                      name="booking-for"
                      onChange={() => this.handleChangeBookingType("self")}
                    />
                    <label className="form-label" htmlFor="for-self">
                      Đặt cho bản thân
                    </label>
                  </div>
                  <div className="form-check">
                    <input
                      ...
                      className="form-check-input"
                      name="booking-for"
                      onChange={() => this.handleChangeBookingType("relative")}
                    />
                    <label className="form-label" htmlFor="for-relative">
                      Đặt cho người thân
                    </label>
                  </div>
                </div>
                <div className="col-6 my-2">
                  ...
                  <input
                    ...
                    disabled={this.state.bookingType === "self" ? true : false}
                ...
                <div className="col-6 my-2">
                  ...
                  <DatePicker
                    onChange={(arg) => this.handleChangeDatePicker(arg)}
                    className="form-control"
                  />
                </div>
                <div className="col-6 my-2">
